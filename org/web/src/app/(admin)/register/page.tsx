...
export default function Page() {
  ...
  const { data, isLoading, isError, error, isFetching } = useAllConsultingList(page, limit)
  ...
  const meta = data?.data?.metadata || { totalRecords: 0, firstPage: 1, lastPage: 1, page: 1, limit: 10 }
