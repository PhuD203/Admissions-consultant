...
class StudentService {
  async getAllStudents(page: number | string = 1, limit: number | string = 10): Promise<{ students: students[], metadata: any } | null> { // CORRECTED: Use 'students[]' as the type
    try {
  ...
  async updateStudent (id : number, student: StudentUpdateDTO) : Promise<students | null> {
